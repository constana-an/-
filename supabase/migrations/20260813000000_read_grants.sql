...
--
-- Why it hid for so long: `20260811060000` grants select on the tables it adds
...
-- through the SECURITY DEFINER functions, and `20260811120000` /
-- `20260811150000` keep insert/update/delete revoked from anon and
